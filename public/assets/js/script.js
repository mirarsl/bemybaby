(function ($) {
  ...
  function thmSwiperInit() {
    ...
    if ($(".thm-swiper__slider").length) {
      $(".thm-swiper__slider").each(function () {
        ...
        thmSwiperSlider.init();
        thmSwiperSlider.on('slideChange', function() {
          $(".video-popup").magnificPopup({
            type: "iframe",
            mainClass: "mfp-fade",
            removalDelay: 160,
  ...
  if ($(".brand-two__carousel").length) {
    let carousel = $(".brand-two__carousel");
  ...
  if ($(".testimonial-five__carousel").length) {
    $(".testimonial-five__carousel").each(function () {
      var carousel = $(this);
      console.log(carousel.data('count'));
      carousel.owlCarousel({
        loop: carousel.data('count') > 2,
        margin: 30,
        nav: carousel.data('count') > 3,
