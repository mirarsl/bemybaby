...
$data = $Page->products()->paginate(12);
                        ...
                        <div class="col-xl-12">
                            <div class="product__showing-result">
                                <div class="product__showing-text-box">
                                    <p class="product__showing-text">Toplam {{$count}} adet üründen {{$data->count()}} tane gösteriliyor</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-12">
                <div class="product__sidebar position-sticky">
                    <div class="shop-search product__sidebar-single">
                        ...
                        @endif
                        <form action="{{route('page',__('links.products'))}}" method="get">
                            @csrf
